...
public class UpdateTeacher extends JFrame implements ActionListener{
    ...
    UpdateTeacher(){
        ...
        try{
            ...
            while(rs.next()){
              ...
              tfbranch.setText(rs.getString("qualification"));  
              tfyear.setText(rs.getString("department"));  
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == submit){
            ...
            try{
                String query = "update teacher set address='"+address+"', phone='"+phone+"', email='"+email+"', qualification='"+branch+"', department='"+year+"' where empId='"+empId+"'";
                Conn con = new Conn();
